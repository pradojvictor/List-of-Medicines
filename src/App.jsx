...
function App() {
  ...
  const SameEmail = "samecapsleste@gmail.com"
  ...
  if (loading) {
    return <div className="loader">
      <div className='div-inf-gif'>
        <img className='git-img' src={gifs.giftLoadPrincipal} alt="Giff de uma garota rindo e acenando" fetchPriority="high"/>
        ...
        <div className='section-footer'>
          ...
          <div className='inf-footer'>
            ...
            <Link href={url} className="link-footer" id="link-fone" rel="noopener noreferrer">
              ...
              <span className='text-link'>(+55) 86 99447-8042</span>
            </Link>
